      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                title ?? Language.of(context).viewStateMessageError,
                style: titleStyle,
              ),
              SizedBox(height: 20),
              ConstrainedBox(
...
class ViewStateErrorWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String defaultTextData = Language.of(context).viewStateButtonRetry;
    switch (error.errorType) {
      case ErrorType.networkError:
        ...
        defaultTitle = Language.of(context).viewStateMessageNetworkError;
        errorMessage = ''; // 网络异常移除message提示
        break;
      case ErrorType.defaultError:
        defaultImage =
            const Icon(IconFonts.pageError, size: 100, color: Colors.grey);
        defaultTitle = Language.of(context).viewStateMessageError;
        break;
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ViewStateWidget(
          ...
          title: message ?? Language.of(context).viewStateMessageEmpty,
          buttonText: buttonText,
          buttonTextData: Language.of(context).viewStateButtonRefresh,
        ));
  }
}
...
class ViewStateUnAuthWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewStateWidget(
      ...
      title: message ?? Language.of(context).viewStateMessageUnAuth,
      buttonText: buttonText,
      buttonTextData: Language.of(context).viewStateButtonLogin,
    );
  }
}
...
class ViewStateButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlineButton(
      child: child ??
          Text(
            textData ?? Language.of(context).viewStateButtonRetry,
